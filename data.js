...
const Database = [
    ...
    {
      id: 78,
      articulo: "Pasta Termica Cpu Cooler Master Mastergel Pro 1.5ml Nuevo!",
      sku: "En general, es una buena idea cambiar la pasta térmica cada uno o dos años . Sin embargo, no recomendamos confiar únicamente en los plazos para monitorear cuándo necesita cambiar su pasta térmica.",
      pregunta: "Cuanto tiempo dura la pasta?, Cada cuanto tiempo se cambia?, Cuanto se aplica?",
      respuestaCorrecta: "Te recomendaría que dejes que el reemplazo lo haga alguien capacitado, o mínimamente, que mires algunos videos tutoriales sobre como hacerlo para que también tengas una idea de cuanto usar indistintamente de como se haga. En general, es una buena idea cambiar la pasta térmica cada uno o dos años . Sin embargo, no recomendamos confiar únicamente en los plazos y monitorear el rendimiento y temperatura del procesador para saber cuándo necesita cambiar su pasta térmica. ",
    },
    {
      id: 79,
      articulo: "Cooler Fan Pc Cooler Master Mf120 Halo White Ed 120mm Argb",
      sku: "MFL-B2DN-18NPA-R1",
      pregunta: "¿Las luces se pueden poner blancas/blanco?",
      respuestaCorrecta: " La sumatoria de los tres colores (R,G,B) da como resultado blanco, es posible.",
    },
    {
      id: 80,
      articulo: "",
